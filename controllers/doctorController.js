...
//API to mark doctors appointements Completed for doctor panel
...
//API to Cancel appointment from the doctors panel
...
//API to get Dashboard data for the doctors 
...
const doctorDashboard = async (req, res) => {
    try {
        ...
        appointments.map((item) => {
            if (!patiants.includes(item.userId)) {
                patiants.push(item.userId)
            }
        })
...
//API to  make changes and to update there profile
